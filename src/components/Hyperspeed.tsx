// @ts-nocheck
/* Vendored from React Bits (Hyperspeed). SMAA pass removed and asset loading
   short-circuited to stay compatible with modern `postprocessing` (6.3x+),
   which dropped SMAAEffect.searchImageDataURL. Bloom carries the look. */
...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      loadAssets() {
        // Modern `postprocessing` handles SMAA assets internally; nothing to preload.
